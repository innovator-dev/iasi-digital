...
a&&a.removeEventListener("click",h);app.map.popup&&app.map.popup.close();app.events.fire("clearDirectionService");document.querySelector(".mapControlsVehicle").classList.add("hide")}return{init:function(){p();x();q(6E4,()=>{l()})},getData:l,show:function(){r();q(2E4,()=>{l(()=>{r()})});app.dataSets.publicTransportation.visible=!0},hide:function(){q(6E4,()=>{l()});Object.values(app.dataSets.publicTransportation.markers).forEach(a=>{a.ref&&a.ref.setMap(null)});app.dataSets.publicTransportation.markers=
