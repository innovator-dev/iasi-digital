...
null);app.dataSets.publicTransportation.selectedMarker=app.dataSets.publicTransportation.markers[a.label].ref;app.map.popup=new google.maps.InfoWindow({content:app.dataSets.publicTransportation.markers[a.label].popup});app.map.popup.open(app.map.ref,app.dataSets.publicTransportation.selectedMarker)}))}})}return{init:function(){m();e();f(6E4,()=>{d()})},getData:d,show:function(){g();f(2E4,()=>{d(()=>{g()})});app.dataSets.publicTransportation.visible=!0},hide:function(){f(6E4,()=>{d()});Object.values(app.dataSets.publicTransportation.markers).forEach(a=>
