...
if(0===app.me.location.lat||0===app.me.location.lng&&app.config.messages["route.error.unableToDetermine"])throw app.config.messages["route.error.unableToDetermine"];if(0===f||0===k&&app.config.messages["parking.error.unableToDetermineLocation"])throw app.config.messages["parking.error.unableToDetermineLocation"];app.map.direction.service.route({origin:new google.maps.LatLng(app.me.location.lat,app.me.location.lng),destination:new google.maps.LatLng(f,k),travelMode:"DRIVING"},function(g,l){"OK"===
