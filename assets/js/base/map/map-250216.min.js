...
class DataSet{constructor(){this.watcher=this._ref=null;this.isVisible=!1;this.data={};this.markers=[];this.props={};this.metrics={}}static fetch(b,a){return CityApp.getSetData({url:CityApp.config.url,method:"POST",postFields:{action:"fetch",type:"api",value:b},callback:a})}static setWatcher(b,a){this.clearWatcher();this.watcher=setInterval(()=>{null!==a&&a()},b)}static clearWatcher(){null!==this.watcher&&(clearInterval(this.watcher),this.watcher=null)}init(){}show(b){}hide(b){}render(b){}hasData(){return 0<
