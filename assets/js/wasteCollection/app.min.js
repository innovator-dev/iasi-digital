...
app.dataSets.wasteCollection.markers[a.VehicleId].ref;app.map.popup=new google.maps.InfoWindow({content:app.dataSets.wasteCollection.markers[a.VehicleId].popup});app.map.popup.open(app.map.ref,app.dataSets.wasteCollection.selectedMarker)})}})}return{init:function(){e(12E4,()=>{c()})},getData:c,show:function(){f();e(3E4,()=>{c(()=>{f()})});app.dataSets.wasteCollection.visible=!0},hide:function(){e(12E4,()=>{c()});Object.values(app.dataSets.wasteCollection.markers).forEach(a=>{a.ref&&a.ref.setMap(null)});
app.dataSets.wasteCollection.markers=[];app.dataSets.wasteCollection.visible=!1}}})();(()=>{app.dataSets.wasteCollection.app=wasteCollection})();
