...
trafficLayer:c.querySelector('input[type=checkbox][name="toggle.mobility.trafficLayer"]'),airQuality:c.querySelector('input[type=checkbox][name="toggle.environment.airQuality"]'),wasteCollection:c.querySelector('input[type=checkbox][name="toggle.environment.wasteCollection"]')};c.classList.remove("hide");c.querySelectorAll(".btn-toggle").forEach(g=>{const d=g.dataset;d.set&&(l[d.set]={app:null,watcher:null,loaded:!1,visible:!1,hasData:!1,updated:null,data:{},markers:[],selectedMarker:null},d.source&&
(k(d.source,()=>{l[d.set].loaded=!0;l[d.set].app.fetch()?(l[d.set].hasData=!0,l[d.set].app.init()):b.controls[d.set].setAttribute("disabled","disabled")}),g.addEventListener("click",()=>{b.controls.spinner.classList.remove("hide");b.controls[d.set].checked?l[d.set].app.show():l[d.set].app.hide();b.controls.spinner.classList.add("hide")})),"trafficLayer"===d.set&&g.addEventListener("click",()=>{b.controls.spinner.classList.remove("hide");b.controls[d.set].checked?(l[d.set].app=new google.maps.TrafficLayer,
l[d.set].app.setMap(b.ref),l[d.set].visible=!0):(l[d.set].visible=!1,l[d.set].app.setMap(null),l[d.set].app=null);b.controls.spinner.classList.add("hide")}))})}});m.add("renderMap",()=>{const c=document.querySelector("#map");if(c){var a=c.dataset;a.bind&&(a=JSON.parse(atob(a.bind)),k(a.url,()=>{b.ref=new google.maps.Map(c,{center:b.mapCenter,zoom:14,streetViewControl:!1,mapTypeControl:!1,fullscreenControl:!1,styles:[{featureType:"administrative",elementType:"labels.text.fill",stylers:[{color:"#444444"}]},
...
stylers:[{visibility:"on"}]},{featureType:"water",elementType:"all",stylers:[{color:"#b4d4e1"},{visibility:"on"}]}]});google.maps.event.addListenerOnce(b.ref,"tilesloaded",()=>{b.loaded=!0;m.fire("mapRenderControls")})}))}});m.fire("renderMap")}}})();(()=>{app.render()})();
