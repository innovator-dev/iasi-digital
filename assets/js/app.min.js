...
d.type="button";d.addEventListener("click",l=>{l.preventDefault();l.stopPropagation();navigator.geolocation?"hideLocation"===d.getAttribute("data-state")?(d.setAttribute("data-state","showLocation"),d.classList.add("selected"),g.classList.remove("hide"),e.watcher=navigator.geolocation.watchPosition(a=>{const q=a.coords.latitude;a=a.coords.longitude;e.location.lat=q;e.location.lng=a;null===e.app&&(e.app=new google.maps.Marker({position:{lat:parseFloat(q),lng:parseFloat(a)},map:app.map.ref,title:"Loca\u021bia mea",
icon:{url:"https://iasi.digital/assets/pin/me.png",size:new google.maps.Size(28,44),origin:new google.maps.Point(0,0),anchor:new google.maps.Point(0,22),scaledSize:new google.maps.Size(28,44)}}),e.app.setMap(c.ref));e.app.setPosition(new google.maps.LatLng(q,a));e.lastUpdate=(new Date).getTime();e.visible=!0;!0===e.persistent&&c.ref.panTo(new google.maps.LatLng(q,a))},()=>{try{throw null!==e.app&&(e.app.setMap(null),e.app=null),null!==e.watcher&&(navigator.geolocation.clearWatch(e.watcher),e.watcher=
null),e.lastUpdate=null,e.visible=!1,e.location.lat=0,e.location.lng=0,"Nu a putut fi determinat\u0103 pozi\u021bia. Verifica\u021bi dac\u0103 browser-ul are permisiunea de a prelua loca\u021bia.";}catch(a){p(a,"error",10),d.setAttribute("data-state","hideLocation"),d.classList.remove("selected"),d.setAttribute("disabled","disabled"),g.classList.remove("selected"),g.classList.add("hide"),g.setAttribute("data-state","disabled"),e.persistent=!1}},{enableHighAccuracy:!0,timeout:5E3})):(d.setAttribute("data-state",
"hideLocation"),d.classList.remove("selected"),g.classList.remove("selected"),g.classList.add("hide"),g.setAttribute("data-state","disabled"),e.persistent=!1,null!==e.app&&(e.app.setMap(null),e.app=null),null!==e.watcher&&(navigator.geolocation.clearWatch(e.watcher),e.watcher=null),e.lastUpdate=null,e.visible=!1,e.location.lat=0,e.location.lng=0):(d.setAttribute("data-state","hideLocation"),d.classList.remove("selected"),d.setAttribute("disabled","disabled"),g.classList.add("hide"))});b.appendChild(g);
b.appendChild(d);c.ref.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(h);c.ref.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(b);c.controls={spinner:f.querySelector("h3 .spinner"),publicTransportation:f.querySelector('input[type=checkbox][name="toggle.mobility.publicTransportation"]'),publicParking:f.querySelector('input[type=checkbox][name="toggle.mobility.publicParking"]'),trafficLayer:f.querySelector('input[type=checkbox][name="toggle.mobility.trafficLayer"]'),airQuality:f.querySelector('input[type=checkbox][name="toggle.environment.airQuality"]'),
wasteCollection:f.querySelector('input[type=checkbox][name="toggle.environment.wasteCollection"]')};f.classList.remove("hide");f.querySelectorAll(".btn-toggle").forEach(l=>{const a=l.dataset;a.set&&(m[a.set]={app:null,watcher:null,loaded:!1,visible:!1,hasData:!1,updated:null,data:{},markers:[],selectedMarker:null},a.source&&(k(a.source,()=>{m[a.set].loaded=!0;m[a.set].app.fetch()?(m[a.set].hasData=!0,m[a.set].app.init()):c.controls[a.set].setAttribute("disabled","disabled")}),l.addEventListener("click",
()=>{c.controls.spinner.classList.remove("hide");c.controls[a.set].checked?m[a.set].app.show():m[a.set].app.hide();c.controls.spinner.classList.add("hide")})),"trafficLayer"===a.set&&l.addEventListener("click",()=>{c.controls.spinner.classList.remove("hide");c.controls[a.set].checked?(m[a.set].app=new google.maps.TrafficLayer,m[a.set].app.setMap(c.ref),m[a.set].visible=!0):(m[a.set].visible=!1,m[a.set].app.setMap(null),m[a.set].app=null);c.controls.spinner.classList.add("hide")}))})}});n.add("renderMap",
()=>{const f=document.querySelector("#map");if(f){var b=f.dataset;b.bind&&(b=JSON.parse(atob(b.bind)),k(b.url,()=>{c.ref=new google.maps.Map(f,{center:c.mapCenter,zoom:14,streetViewControl:!1,mapTypeControl:!1,fullscreenControl:!1,styles:[{featureType:"administrative",elementType:"labels.text.fill",stylers:[{color:"#444444"}]},{featureType:"landscape",elementType:"all",stylers:[{color:"#f2f2f2"}]},{featureType:"poi",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"poi.business",elementType:"geometry.fill",
stylers:[{visibility:"off"}]},{featureType:"road",elementType:"all",stylers:[{saturation:-100},{lightness:45}]},{featureType:"road.highway",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"road.arterial",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"transit",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"water",elementType:"all",stylers:[{color:"#b4d4e1"},{visibility:"on"}]}]});google.maps.event.addListenerOnce(c.ref,"tilesloaded",()=>{c.loaded=
!0;n.fire("mapRenderControls")})}))}});n.fire("renderMap")}}})();(()=>{app.render()})();
