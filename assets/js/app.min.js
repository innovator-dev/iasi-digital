...
a.json():!1).then(a=>{null!==d.callback&&d.callback(a)}).catch(a=>!1),!0}catch(a){m(a,"error",10)}},route:function(){const d=["route","method","query"];var a=window.location.pathname;const h=window.location.hash,g={};if(a&&(a=a.replace(/^\/?|\/?$/g,"").split("/"),0<a.length))for(let e=0;e<d.length;e++)g[d[e]]=a[e];h&&(g.hash=h.substring(1));return g},notify:m,render:function(){n.add("initiateDirectionService",()=>{b.loaded&&(null===b.direction.service&&(b.direction.service=new google.maps.DirectionsService),
null===b.direction.renderer&&(b.direction.renderer=new google.maps.DirectionsRenderer,b.direction.renderer.setMap(b.ref)),b.direction.loaded=!0)});n.add("clearDirectionService",()=>{null!==b.direction.service&&(b.direction.service=null);null!==b.direction.renderer&&(b.direction.renderer.setMap(null),b.direction.renderer=null);b.direction.loaded=!1});n.add("showMyLocation",()=>{n.fire("initiateDirectionService")});n.add("hideMyLocation",()=>{n.fire("clearDirectionService")});n.add("mapRenderControls",
()=>{const d=document.querySelector(".mapControls");if(d&&b.loaded){const h=document.createElement("div");h.classList.add("mapControlsContainer");var a=document.createElement("button");a.classList.add("mapCustomControl");a.innerHTML='<span data-icon="&#xe013;"></span>';a.title="Centreaz\u0103 harta pe Municipiul Ia\u0219i";a.type="button";a.addEventListener("click",l=>{l.preventDefault();l.stopPropagation();0<b.mapCenter.lat&&0<b.mapCenter.lng&&(b.ref.panTo(new google.maps.LatLng(b.mapCenter.lat,
