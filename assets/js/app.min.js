...
"warning");c.innerHTML="";c.parentNode.removeChild(c)},1E3*h)}}function t(){n.add("renderMap",()=>{const d=document.querySelector("#map");d&&app.config.map&&k(app.config.map,()=>{b.ref=new google.maps.Map(d,{center:b.mapCenter,zoom:14,streetViewControl:!1,mapTypeControl:!1,fullscreenControl:!0,mapId:"4c67bc89ba82ae84"});google.maps.event.addListenerOnce(b.ref,"tilesloaded",()=>{b.loaded=!0;n.fire("mapRenderControls");google.maps.importLibrary("marker")})})});n.fire("renderMap")}const n=new Observer,
p={},b={ref:null,mapCenter:{lat:47.1553424,lng:27.585645},loaded:!1,popup:null,controls:{},direction:{loaded:!1,service:null,renderer:null}},f={app:null,watcher:null,visible:!1,updated:null,location:{lat:0,lng:0},persistent:!1};return{cdn:"https://iasi.digital/assets/",config:{},events:n,map:b,me:f,dataSets:p,dateDiff:function(d,a=!1){let h=d.split(/\D/);d=new Date;a&&(d=new Date(d.getTime()+6E4*d.getTimezoneOffset()));a=new Date(h[0],h[1]-1,h[2],h[3],h[4],h[5]);if(isNaN(d)||isNaN(a))return null;
...
d.method||"GET",d.postFields||{}).then(a=>a.ok?a.json():!1).then(a=>{null!==d.callback&&d.callback(a)}).catch(a=>!1),!0}catch(a){m(a,"error",10)}},route:function(){const d=["route","method","query"];var a=window.location.pathname;const h=window.location.hash,g={};if(a&&(a=a.replace(/^\/?|\/?$/g,"").split("/"),0<a.length))for(let e=0;e<d.length;e++)g[d[e]]=a[e];h&&(g.hash=h.substring(1));return g},notify:m,render:function(){n.add("initiateDirectionService",()=>{b.loaded&&(null===b.direction.service&&
(b.direction.service=new google.maps.DirectionsService),null===b.direction.renderer&&(b.direction.renderer=new google.maps.DirectionsRenderer,b.direction.renderer.setMap(b.ref)),b.direction.loaded=!0)});n.add("clearDirectionService",()=>{null!==b.direction.service&&(b.direction.service=null);null!==b.direction.renderer&&(b.direction.renderer.setMap(null),b.direction.renderer=null);b.direction.loaded=!1});n.add("showMyLocation",()=>{n.fire("initiateDirectionService")});n.add("hideMyLocation",()=>{n.fire("clearDirectionService")});
